...
2. **Download.** The pinned `msb` release (currently `0.7.3`) is fetched from GitHub
...
5. **Cache.** Everything lands under `~/.cache/rightsize/msb/0.7.3/` (or
